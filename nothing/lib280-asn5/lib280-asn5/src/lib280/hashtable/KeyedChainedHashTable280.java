...
public class KeyedChainedHashTable280<K extends Comparable<? super K>, I extends Keyed280<K> > extends HashTable280<I> implements
	 ...
	 * @throws ItemNotFoundException if y is not in the hash table.
	 * @returns The matching object in the hash table if it exists.
	 * 
	 */
	 ...
	 * 
	 * @precond y is in the hash table
	 * @returns true if y is in the hash table, false otherwise.
	 * 
	 */
