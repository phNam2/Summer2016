...
public interface KeyedBasicDict280<K extends Comparable<? super K>, I extends Keyed280<K>> 
{
	 ...
	 * @precond !isFull() 
	 * @precond	!has(x.key())
	 * @throws Throws a DuplicateItems280Exception if an item with key x.key() already exist in the dictionary.
	 * @throws Throws a ContainerFull280Exception if the dictionary is full. 
	 ...
	 * @precond has(x.key())
	 *  @throws Throws an ItemNotFound280Exception if there is no item with key k.
